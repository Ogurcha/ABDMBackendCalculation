...
namespace Abdm.Calculation.BLL.Models
{
    ...
    public class LoadModel
    {
        ...
        /// <summary>
        /// Расстояние от центральной оси ТС до всех возможных центров колес С ОДНОЙ СТОРОНЫ
        /// Например, если в параметры передаётся легковушка с двумя <see cref="Axle"/> и четырмя колёсами, 
        /// то вернётся словарь <расстояниеОтЦентраКолесаДоЦентраТС, (2, w)>. Вернётся только одно значение, так как переднее и заднее колесо на одинаковом расстоянии. Число два означает, что на таком расстоянии оба значения. 
